"""
Configurações base para o projeto Django.
Compartilhada por todas as configurações.
"""
...
# Database - Configuração base para múltiplos bancos de dados
DATABASES = {
    'default': {
...
# Configuração para roteamento de banco de dados
